...
import 'package:mindteck_iot/models/category/category_data.dart';
...
class _AddDeviceScreenState extends ConsumerState<AddDeviceScreen> {
  ...
  void _addDevice(WidgetRef ref) async {
    ...
    print('deviceData: $_deviceData');

    //ref.read(addDeviceProvider(_deviceData!));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              _addDevice(ref);
              ref.read(addDeviceProvider(_deviceData!).future).then((data) {
